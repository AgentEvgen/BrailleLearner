...
| **Практика** (3 уровня) | • *Лёгкий*: выбор из 2–10 вариантов <br> • *Лёгкие слова*: ответвление от легкого уровня, где вместо букв - слова <br> • *Средний*: ввод символов Брайля на виртуальной клавиатуре 2×3 <br> • *Сложный*: найди и исправь ошибку в слове  <br> • *Быстрое повторение*: ответ за ограниченное время |
